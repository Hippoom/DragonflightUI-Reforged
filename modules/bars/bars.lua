DFRL:NewDefaults("Bars", {
    ...
    multiBarOneSpacing = {6, "slider", {0, 20}, nil, "multibar 1", 11, "Adjusts spacing between bottom left action bar buttons", nil, nil},
    ...
    multiBarTwoSpacing = {6, "slider", {0, 20}, nil, "multibar 2", 16, "Adjusts spacing between bottom right action bar buttons", nil, nil},
    ...
    multiBarThreeSpacing = {6, "slider", {0, 20}, nil, "multibar 3", 21, "Adjusts spacing between left action bar buttons", nil, nil},
    ...
    multiBarFourSpacing = {6, "slider", {0, 20}, nil, "multibar 4", 26, "Adjusts spacing between right action bar buttons", nil, nil},
    ...
    petbarSpacing = {6, "slider", {0, 20}, nil, "pet bar", 52, "Adjusts spacing between pet action bar buttons", nil, nil},
    ...
    shapeshiftSpacing = {6, "slider", {0, 20}, nil, "shapeshift bar", 55, "Adjusts spacing between shapeshift buttons", nil, nil},
